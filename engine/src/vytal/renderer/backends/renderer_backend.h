...
VYTAL_API RendererBackendResult renderer_backend_startup(const RendererBackendType backend_type, Window *out_first_window, ConstStr shaders_filepath, RendererBackend *out_backend);
