...
VT_API PoolAllocator allocator_pool_construct_aligned(const ByteSize capacity, const ByteSize chunk_count,
                                                      const ByteSize alignment);
...
VT_API VT_INLINE PoolAllocator allocator_pool_construct(const ByteSize capacity, const ByteSize chunk_count) {
    return allocator_pool_construct_aligned(capacity, chunk_count, VT_MEM_DEFAULT_ALIGNMENT);
}
