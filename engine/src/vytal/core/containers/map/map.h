...
VT_API Map      container_map_construct(void);
VT_API Bool     container_map_destruct(Map map);
VT_API Bool     container_map_insert(Map map, const VoidPtr key, const VoidPtr data, const ByteSize data_size);
VT_API Bool     container_map_remove(Map map, const VoidPtr key);
VT_API VoidPtr  container_map_search(Map map, const VoidPtr key);
VT_API Bool     container_map_update(Map map, const VoidPtr key, const VoidPtr new_data, const ByteSize new_data_size);
VT_API Bool     container_map_clear(Map map);
