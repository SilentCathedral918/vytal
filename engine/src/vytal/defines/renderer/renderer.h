...
typedef enum Renderer_Backend_Result {
    ...
    RENDERER_BACKEND_ERROR_VULKAN_DEPTH_RESOURCES_CONSTRUCT_FAILED        = -126,
    RENDERER_BACKEND_ERROR_VULKAN_DEPTH_RESOURCES_DESTRUCT_FAILED         = -127,
    RENDERER_BACKEND_ERROR_VULKAN_GRAPHICS_PIPELINE_CONSTRUCT_FAILED      = -128,
    RENDERER_BACKEND_ERROR_VULKAN_GRAPHICS_PIPELINE_DESTRUCT_FAILED       = -129,
    RENDERER_BACKEND_ERROR_VULKAN_GRAPHICS_UBOS_CONSTRUCT_FAILED          = -130,
    RENDERER_BACKEND_ERROR_VULKAN_GRAPHICS_UBOS_DESTRUCT_FAILED           = -131,
    RENDERER_BACKEND_ERROR_VULKAN_SYNC_RESOURCES_CONSTRUCT_FAILED         = -132,
    RENDERER_BACKEND_ERROR_VULKAN_SYNC_RESOURCES_DESTRUCT_FAILED          = -133,
    RENDERER_BACKEND_ERROR_VULKAN_DESCRIPTOR_SETS_CONSTRUCT_FAILED        = -134,
    RENDERER_BACKEND_ERROR_VULKAN_DESCRIPTOR_SETS_DESTRUCT_FAILED         = -135,
    RENDERER_BACKEND_ERROR_VULKAN_COMMAND_BUFFERS_ALLOCATE_FAILED         = -136,
    RENDERER_BACKEND_ERROR_VULKAN_COMMAND_BUFFERS_DEALLOCATE_FAILED       = -137,
