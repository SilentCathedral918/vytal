...
VT_API AudioSource *audio_module_construct_source(ConstStr id);
VT_API AudioSource *audio_module_construct_source_with_buffer(ConstStr source_id, ConstStr buffer_id);
...
VT_API Bool         audio_module_play_audio(ConstStr source_id);
VT_API Bool         audio_module_play_audio_from_file(ConstStr filepath);
