...
rem --- defines
set "defines=-DVYTAL_DEBUG -DVYTAL_ENABLE_ASSERTIONS -DVYTAL_EXPORT_DLL -D_CRT_SECURE_NO_WARNINGS -DLINE_BUFFER_MAX_SIZE=8192 -DCVAR_HASHMAP_SIZE=1024 -DMAX_EXCEPTION_DEPTH=10 -DMEMORY_ALIGNMENT_SIZE=16 "
